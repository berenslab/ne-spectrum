...
if __name__ == "__main__":
    ...
    for gamma in [100, 50, 10, 1]:
        ...
        d = (
            dsrc
            / prep
            / f"tsnee;learning_rate:1;early_exaggeration:1;elastic_const:{gamma};learning_rate:{lr};eps:1;n_iter:10000"
        )
    ...
    relname = sys.argv[2]
    plotter = jnb_msc.anim.ScatterMultiple(
        datapaths, plotname=relname, titles=titles, format="png", scalebars=0.3
    )
    filedeps = set(
        [
            mod.__file__
